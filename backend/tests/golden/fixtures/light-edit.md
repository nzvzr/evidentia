...
Customer data is always stored and processed regionally. Data residency and
data sovereignty controls apply to regulated workloads, and GDPR data
protection obligations govern European deployments.
