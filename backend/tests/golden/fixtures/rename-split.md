...
All administrative access uses single sign-on with SAML and RBAC. Audit logging records every privileged action, and encryption at rest protects stored records.
