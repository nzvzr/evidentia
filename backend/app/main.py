...
from app.api import auth, companies, documents, exports, feedback, personas, reports
...
# Renderer Track R1: tenant-scoped report export (editable DOCX). Registered
# after reports so both share the /api/reports prefix; export paths are distinct.
